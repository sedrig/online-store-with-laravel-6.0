...
<br>
<input type="hidden" name="_token" value="6at1jHVtAP2HZW7yEPHH2odxMAUrNdt1sbo3CEO7">
                <input type="submit" class="btn btn-success" href='{{ route('index') }}' value="Подтвердите заказ">
</div>
@csrf 
</form>
</div>
